...
$ExifToolPath = $Config.paths.tools.exifTool
$ffprobe = $Config.paths.tools.ffprobe
...
$mediaFiles = Get-ChildItem -Path $processedDirectory -Recurse -File
& $Log "INFO" "Discovered $($mediaFiles.Count) media files under $processedDirectory"
